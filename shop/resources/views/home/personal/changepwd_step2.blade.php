...
@endif	
	...
	<div class="pull-right">
		<div class="user-content__box clearfix bgf">
			...
			<form action="{{URL('home/personal/changepwd_step3')}}" method='post' class="user-setting__form" role="form">
				{{csrf_field()}}
				...
				<div class="form-group">
				<div class="form-group">
					<input class="form-control" name="repassword" required=""  autocomplete="off" type="password">
