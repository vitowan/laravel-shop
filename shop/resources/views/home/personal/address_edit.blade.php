...
<div class="pull-right">
	<div class="user-content__box clearfix bgf">
		...
		<form action="{{URL('home/personal/addr_doupdate')}}" class="user-addr__form form-horizontal" role="form" method='post'>
			{{csrf_field()}}
			<input type="hidden" name='address_id' value="{{$res->address_id}}">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input class="form-control" id="name" name="receiver_name" value="{{$res->receiver_name}}" placeholder="请输入姓名" type="text">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<input class="form-control" id="details" name='details' placeholder="建议您如实填写详细收货地址，例如街道名称，门牌号码等信息" value="{{$res->address_detail}}" maxlength="30" type="text">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input class="form-control" id="mobile" name="receiver_tel" value="{{$res->receiver_tel}}" placeholder="请输入手机号码" type="text">
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-6">
					<div class="checkbox">
						<label><input type="checkbox" name='address_default' @if($res->address_default==1) checked @endif value='1'><i></i> 设为默认收货地址</label>
					</div>
				</div>
			</div>
			<div class="form-group">
