...
<html lang="en">
	...
	<body>
					...
					<ul class="nav ace-nav">
						...
						<li class="green">
							...
							<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li>
									<a href="#">
										<img src="{{URL('admin/assets')}}/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
										<span class="msg-body">
								...
								<li>
									<a href="#">
										<img src="{{URL('admin/assets')}}/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="#">
										<img src="{{URL('admin/assets')}}/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="{{URL('admin/assets')}}/avatars/user.jpg" alt="Jason's Photo" />
					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="{{URL('admin/catepic/cate_pic')}}">
										<i class="icon-double-angle-right"></i>
										主分类广告图
									</a>
								</li>
		...
		<script src="{{URL('admin/assets')}}/js/typeahead-bs2.min.js"></script>
		...
		<script src="{{URL('admin/assets')}}/js/jquery-ui-1.10.3.custom.min.js"></script>
		...
		<script src="{{URL('admin/assets')}}/js/jquery.easy-pie-chart.min.js"></script>
		<script src="{{URL('admin/assets')}}/js/jquery.sparkline.min.js"></script>
<!-- 		<script src="{{URL('admin/assets')}}/js/flot/jquery.flot.min.js"></script> -->
<!-- 		<script src="{{URL('admin/assets')}}/js/flot/jquery.flot.pie.min.js"></script>
<script src="{{URL('admin/assets')}}/js/flot/jquery.flot.resize.min.js"></script> -->
